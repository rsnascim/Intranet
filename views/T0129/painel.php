                                        ...
                                        <td>
                                            ...
                                            <?php $Arq = $objAp->selecionaArquivos($valores['APCodigo']); foreach($Arq  as  $campos=>$valores2){
                                                ...
                                                <tr class="<?php echo $cor; ?>">
                                                    <td width="95%" ><a target="_blank" href="<?php echo CAMINHO_ARQUIVOS_HOLD."CAT".$valores2['CAT']=$objAp->preencheZero("E", 4, $valores2['CAT'])."/".$arquivo=$objAp->preencheZero("E", 4, $valores2['ARQ']).".".$valores2['EXT']?>"><?php echo $valores2['NOM'];?></a></td>
